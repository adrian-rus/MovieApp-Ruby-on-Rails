...
class DirectorsControllerTest < ActionController::TestCase
  ...
  test "should create director" do
    assert_difference('Director.count') do
      post :create, director: { firstname: @director.firstname, lastname: @director.lastname, movie_id: @director.movie_id }
    end
  ...
  test "should update director" do
    patch :update, id: @director, director: { firstname: @director.firstname, lastname: @director.lastname, movie_id: @director.movie_id }
    assert_redirected_to director_path(assigns(:director))
  end
